  ...
  return (
    <>
      ...
      <div className="px-32 w-full  text-center font-bold  py-28 flex flex-col justify-center items-center">
        ...
        <img
          className="bestroom sm:hidden w-[856px] sm:w-[100%]  h-[455px] pb-10"
          alt="Rooms"
          src={single1}
        ></img>
        <div className="grid grid-cols-3 gap-5 w-[75%] sm:grid-cols-1 sm:w-[250%] ">
          <img
            alt=""
      ...
      <RoomDesc price="N100,000" capacity="5 people" />
      <Footer />
    </>
  );
}
